...
def main():
    all_recipes = load_recipes("/home/aron/ws/propra/einkaufsliste-defekt/einkaufsliste/recipes.json")
    all_ingredient_locs = load_ingredient_locations("/home/aron/ws/propra/einkaufsliste-defekt/einkaufsliste/ingredients.json")
